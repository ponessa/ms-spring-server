...
public class JrsMapNode {
	...
	public JrsMapNode(String growthPlatformNm, String serviceLineNm, String practiceNm, String serviceAreaNm,
			String capacityGroupNm, String jrsNm, String newGrowthPlatformNm, String newServiceLineNm,
			String newPracticeNm, String economicModelNm, String newServiceAreaNm, String newJrsNm,
			String practiceTypeNm, String jrsActionNm, String comments) {
		super();
