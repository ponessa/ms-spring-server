...
public class UtAccessController {
	...
	public List<UtNode> findAllUt(@RequestParam(defaultValue = "10J00") String utlevel10
		...
		return utAccessService.findAllEdsUt(utlevel10, ocstatus);
	}
	...
	//@RequestParam(required=false, defaultValue="true") @ApiParam(value="Include in output only rows for branches in error.")
	@GetMapping("/ut")
	public List<UtNode> findUt(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default) to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Service Line Code") String utlevel17
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="GBS Practice Code") String gbspracticecode
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Financial Offering Portfolio") String utlevel20
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Offering") String utlevel30
			, @RequestParam(required=false, defaultValue = "") @ApiParam(value="Additional query string") String addlQueryString
			) {
	...
	public List<BrandDim> findBrandsUt(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default) to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open. Use ‘ALL’ to get all data.") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services. Use ‘ALL’ to get all data.") String utlevel10
			)  {
	...
	public List<GrowthPlatformDim> findUtGrowthPlatforms(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "") @ApiParam(value="Additional query string") String addlQueryString
	...
	public List<BrandDim> findUtGrowthPlatformsTax(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "") @ApiParam(value="Additional query string") String addlQueryString
	...
	public List<ServiceLineDim> findUtServiceLines(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Service Line Code") String utlevel17
	...
	public List<BrandDim> findUtServiceLineTax(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Service Line Code") String utlevel17
	...
	public List<PracticeDim> findUtPracticess(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Service Line Code") String utlevel17
	...
	public List<BrandDim> findUtPracticeTax(@RequestParam(required=false, defaultValue = "ALL") @ApiParam(value="Size of the results, use ‘ALL’ (default)to get all data.") String size
			, @RequestParam(required=false, defaultValue = "O") @ApiParam(value="UT Status. O = Open") String ocstatus
			, @RequestParam(required=false, defaultValue = "10J00") @ApiParam(value="Brand Code. 10J00 = Global Business Services") String utlevel10
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Growth Platform Code") String utlevel15
			, @RequestParam(required=false, defaultValue = "all") @ApiParam(value="Service Line Code") String utlevel17
