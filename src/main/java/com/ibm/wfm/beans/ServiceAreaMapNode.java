...
public class ServiceAreaMapNode {
	...
	public ServiceAreaMapNode(String growthPlatformNm, String serviceLineNm, String practiceNm, String serviceAreaNm,
			String newServiceAreaNm, String newPracticeNm, String newServiceLineNm, String newEconomicModelNm,
			String newGrowthPlatformNm, String practiceTypeNm, String practiceConfirmedInd, String comments) {
		super();
