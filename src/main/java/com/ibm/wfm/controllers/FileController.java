...
public class FileController {
    ...
    public List<String> listUploadDirectory(@RequestParam(value="filePatterns", required=false, defaultValue="") @ApiParam(value="File name or pattern. Multiple can be comma separated") String filePattern) {
    ...
    public int deleteUploadDirectory(@RequestParam(value="filePatterns", required=false, defaultValue="") @ApiParam(value="File name or pattern. Multiple can be comma separated") String filePattern) {
		String[] filePatterns = filePattern.split(",");
		int fileCnt=0;
		for (String fp: filePatterns) {
			List<String> files = FileHelpers.getFileList(fileStorageProperties.getUploadDir()+"/"+fp);
    ...
    @PostMapping("/uploadFile/{directory}")
